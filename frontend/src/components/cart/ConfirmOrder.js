            ...
            <div className="row d-flex justify-content-between">
                            ...
                            <div className="cart-item my-1" key={item.product}>
                                <div className="row">
                                    ...
                                    <div className="col-4 col-lg-4 mt-4 mt-lg-0">
                                        <p>{item.quantity} x {item.price} RWF = <b>{(item.quantity * item.price).toFixed(2)} RWF</b></p>
                                    </div>
                ...
                <div className="col-12 col-lg-3 my-4">
                    <div id="order_summary">
                        ...
                        <p>Total in RWF: <span className="order-summary-values">{totalPrice} RWF</span></p>
                        <p>Total in $: <span className="order-summary-values">${totalPrices}</span></p>
